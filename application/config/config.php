...
$config['csrf_token_name'] = 'csrf_token_aware';
$config['csrf_cookie_name'] = 'csrf_cookie_aware';
$config['csrf_expire'] = 7200;

// Exclude webservice/index function from CSRF check (devices will be sending data using this)
// Added controller awaredev pinging
$config['csrf_excludes'] = array( '@^/?webservice/index/?@i' );
